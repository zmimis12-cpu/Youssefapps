...
const CURRENCY_NAMES: Record<Currency, { one: string; many: string; centOne: string; centMany: string }> = {
  MAD: { one: 'dirham', many: 'dirhams', centOne: 'centime', centMany: 'centimes' },
  USD: { one: 'dollar', many: 'dollars', centOne: 'cent', centMany: 'cents' },
  EUR: { one: 'euro', many: 'euros', centOne: 'centime', centMany: 'centimes' },
  GBP: { one: 'livre sterling', many: 'livres sterling', centOne: 'penny', centMany: 'pence' },
